...
export const Footer = (): JSX.Element => {
  ...
  const navigationLinks = [ {label:'How it works',link:'#howWork'}, {label:'Solutions',link:'#solution'},,{label:'Testimonials',link:'#Testimonials'},{label:'Become an AI Hacker',link:'#Game'}];
  ...
  return (
    <div className="flex flex-col w-full items-start gap-12 md:gap-[100px] relative">
      <div className="flex flex-col items-center gap-12 md:gap-[100px] relative self-stretch w-full flex-[0_0_auto]">
        <div className="relative md:w-full mx-5 max-w-[1260px] md:mx-auto h-auto md:h-[426px] bg-[#0a0818] rounded-2xl md:rounded-[32px] overflow-hidden">
