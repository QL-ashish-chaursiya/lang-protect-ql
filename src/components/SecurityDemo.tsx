...
export const  SecurityDemo = (): JSX.Element => {
  return (
    <section className="relative w-full bg-[url('/Images/securityBg.svg')] bg-no-repeat bg-cover bg-center w-full overflow-hidden py-12 md:py-20">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 md:gap-14 px-4 md:px-8 max-w-6xl mx-auto">
        <div className="flex flex-col items-center gap-3.5 max-w-[774px]">
          ...
          <p className="font-light text-[#4E5976] text-base md:text-lg lg:text-xl text-center tracking-[0] leading-6 md:leading-[30px]">
            Write a prompt to check if its safe or try tricking it to reveal a
            secret.
          </p>
        </div>

        <Card className="w-full max-w-[970px] bg-[#FFFFFF] border-none rounded-2xl md:rounded-[32px] p-6 md:p-8 lg:p-[42px]">
  ...
  className="
    ...
    text-[#C9C7D4] text-base md:text-lg lg:text-xl 
    [font-family:'Mozilla_Text',Helvetica] font-normal 
    placeholder:text-[#C9C7D4] resize-none p-4 securityThreat
  "
/>
